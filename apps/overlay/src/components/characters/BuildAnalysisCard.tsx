...
export default function BuildAnalysisCard({ analysis, onClose }: { analysis: BuildAnalysis; onClose: () => void }) {
  return (
      ...
      <WitchSays title={`Build Analysis — ${analysis.overallRating}/10`}>
        <div className="space-y-2">
          ...
          {analysis.strengths.length > 0 && (
            <div>
              <div className="text-xs font-bold" style={{ color: COLORS.green }}>Strengths</div>
          ...
          {analysis.weaknesses.length > 0 && (
            <div>
              <div className="text-xs font-bold" style={{ color: COLORS.red }}>Weaknesses</div>
          ...
          {analysis.upgrades.length > 0 && (
            <div>
              ...
              {analysis.upgrades.map((u, i) => (
                <div key={i} className="text-xs mt-1 pl-2 border-l-2" style={{ borderColor: PRIORITY_COLORS[u.priority] || "#888" }}>
