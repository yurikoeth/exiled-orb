...
- **Leveling Guide** — Step-by-step guides for PoE1 (Acts 1–10, all 24 quest passive points) and PoE2 (Acts 1–4; the three post-Act-4 Interludes are not covered yet) with per-character checklists that auto-advance as you change zones.
